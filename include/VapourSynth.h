...
typedef void (VS_CC *VSFilterGetAudio)(VSCore *core, const VSAPI *vsapi, void *instanceData, void *lpBuffer, long lStart, long lSamples);
...
struct VSAPI {
    ...
    void (VS_CC *createFilter)(const VSMap *in, VSMap *out, const char *name, VSFilterInit init, VSFilterGetFrame getFrame, VSFilterFree free, VSFilterGetAudio getAudio, int filterMode, int flags, void *instanceData, VSCore *core) VS_NOEXCEPT;
    ...
    const void (VS_CC *getAudio)(VSNodeRef *node, void *lpBuffer, long lStart, long lSamples) VS_NOEXCEPT;
