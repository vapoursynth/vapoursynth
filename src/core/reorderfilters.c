...
static void VS_CC trimCreate(const VSMap *in, VSMap *out, void *userData, VSCore *core, const VSAPI *vsapi) {
    ...
    *data = d;
    ...
    vsapi->createVideoFilter(out, "Trim", &vi, 1, trimGetframe, singleClipFree, fmParallel, nfNoCache, data, core);
}
...
static void VS_CC interleaveCreate(const VSMap *in, VSMap *out, void *userData, VSCore *core, const VSAPI *vsapi) {
    ...
    if (d.numclips == 1) { // passthrough for the special case with only one clip
        ...
        *data = d;
        ...
        vsapi->createVideoFilter(out, "Interleave", &data->vi, 1, interleaveGetframe, interleaveFree, fmParallel, nfNoCache, data, core);
    }
}
...
static void VS_CC reverseCreate(const VSMap *in, VSMap *out, void *userData, VSCore *core, const VSAPI *vsapi) {
    ...
    *data = d;
    ...
    vsapi->createVideoFilter(out, "Reverse", data->vi, 1, reverseGetframe, singleClipFree, fmParallel, nfNoCache, data, core);
}
...
static void VS_CC loopCreate(const VSMap *in, VSMap *out, void *userData, VSCore *core, const VSAPI *vsapi) {
    ...
    *data = d;
    ...
    vsapi->createVideoFilter(out, "Loop", &vi, 1, loopGetframe, singleClipFree, fmParallel, nfNoCache, data, core);
}
...
static void VS_CC selectEveryCreate(const VSMap *in, VSMap *out, void *userData, VSCore *core, const VSAPI *vsapi) {
    ...
    *data = d;
    ...
    vsapi->createVideoFilter(out, "SelectEvery", &vi, 1, selectEveryGetframe, selectEveryFree, fmParallel, nfNoCache, data, core);
}
...
static void VS_CC spliceCreate(const VSMap *in, VSMap *out, void *userData, VSCore *core, const VSAPI *vsapi) {
    ...
    if (d.numclips == 1) { // passthrough for the special case with only one clip
        ...
        *data = d;
        ...
        vsapi->createVideoFilter(out, "Splice", &vi, 1, spliceGetframe, spliceFree, fmParallel, nfNoCache, data, core);
    }
}
...
static void VS_CC duplicateFramesCreate(const VSMap *in, VSMap *out, void *userData, VSCore *core, const VSAPI *vsapi) {
    ...
    *data = d;
    ...
    vsapi->createVideoFilter(out, "DuplicateFrames", &data->vi, 1, duplicateFramesGetFrame, duplicateFramesFree, fmParallel, nfNoCache, data, core);
}
...
static void VS_CC deleteFramesCreate(const VSMap *in, VSMap *out, void *userData, VSCore *core, const VSAPI *vsapi) {
    ...
    *data = d;
    ...
    vsapi->createVideoFilter(out, "DeleteFrames", &data->vi, 1, deleteFramesGetFrame, deleteFramesFree, fmParallel, nfNoCache, data, core);
}
...
static void VS_CC freezeFramesCreate(const VSMap *in, VSMap *out, void *userData, VSCore *core, const VSAPI *vsapi) {
    ...
    *data = d;
    ...
    vsapi->createVideoFilter(out, "FreezeFrames", data->vi, 1, freezeFramesGetFrame, freezeFramesFree, fmParallel, nfNoCache, data, core);
}
