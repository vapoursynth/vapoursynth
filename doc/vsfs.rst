...
=============================
VSFS is based on `AVFS <http://www.turtlewar.org/avfs/>`_ and shares most of its source code and functionality.
...
It can also be used to bridge the 32/64 bit gap, since a plain file can always be read.
